...
/datum/action/cooldown/spell/lichdom/cast(mob/living/cast_on)
	...
	qdel(src)
/*
/datum/action/cooldown/spell/lichdom/lesser
	...
	intact and on the same plane you can revive from death for a extremely limited number of times, though the time \
...
/datum/component/phylactery/lesser
	base_respawn_time = 6 MINUTES // double normal
	max_ressurections = 1
	stun_per_resurrection = 1 MINUTE // long stun
	phylactery_color = COLOR_BLUE_LIGHT
