...
/obj/item/gun/ballistic/bow/compact
	...
	var/on_sound = 'monkestation/sound/weapons/gun/bow/cbow_on.ogg'
	var/off_sound = 'monkestation/sound/weapons/gun/bow/cbow_off.ogg'
	var/charge_sound = 'monkestation/sound/weapons/gun/bow/cbow_charge.ogg'
	var/warning_sound = 'monkestation/sound/weapons/gun/bow/cbow_warning.ogg'
	var/choice_arrow_sound = 'monkestation/sound/weapons/gun/bow/cbow_choice_arrow.ogg'
	var/sound_volume = 40
...
/obj/item/gun/ballistic/bow/compact/update_overlays()
	. = ..()
	if(charged)
		if(istype(chambered, /obj/item/ammo_casing/caseless/arrow/intangible/standart))
			. += "[base_icon_state]_standart"
		if(istype(chambered, /obj/item/ammo_casing/caseless/arrow/intangible/emp))
			. += "[base_icon_state]_emp"
		if(istype(chambered, /obj/item/ammo_casing/caseless/arrow/intangible/repulse))
...
/obj/item/gun/ballistic/bow/compact/proc/pick_arrow(mob/user)
	var/list/allowed_arrows = list(
		"Damage Arrow" = image(icon = 'icons/obj/weapons/guns/bows/arrows.dmi', icon_state = "intangible_standart"),
		"EMP Arrow" = image(icon = 'icons/obj/weapons/guns/bows/arrows.dmi', icon_state = "intangible_emp"),
		"Repulse Arrow" = image(icon = 'icons/obj/weapons/guns/bows/arrows.dmi', icon_state = "intangible_repulse")
		)
	...
	switch(choice_arrow)
		if("Damage Arrow")
			if(damage_arrow_control < ARROW_WIRE_ALRIGHT)
				...
				return FALSE
			if(damage_arrow_control > ARROW_WIRE_ALRIGHT)
				return new /obj/item/ammo_casing/caseless/arrow/intangible/standart/pulsed
			else
				return new /obj/item/ammo_casing/caseless/arrow/intangible/standart
		if("EMP Arrow")
			if(emp_arrow_control < ARROW_WIRE_ALRIGHT)
				invalid_arrow(user)
				return FALSE
			if(emp_arrow_control > ARROW_WIRE_ALRIGHT)
				return new /obj/item/ammo_casing/caseless/arrow/intangible/emp/pulsed
			else
				return new /obj/item/ammo_casing/caseless/arrow/intangible/emp
		if("Repulse Arrow")
			if(repulse_arrow_control < ARROW_WIRE_ALRIGHT)
				invalid_arrow(user)
				return FALSE
			if(repulse_arrow_control > ARROW_WIRE_ALRIGHT)
				return new /obj/item/ammo_casing/caseless/arrow/intangible/repulse/pulsed
			else
				return new /obj/item/ammo_casing/caseless/arrow/intangible/repulse

/obj/item/ammo_box/magazine/internal/bow/compact
	name = "compact core"
	ammo_type = /obj/item/ammo_casing/caseless/arrow/intangible
